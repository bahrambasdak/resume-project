    ...
    <div className={classes.about_me} id="aboutMe">
      ...
      <div className={classes.left}>
        ...
        <p>
          ...
          همچنین کتابخانه های مربوطه رسیده ام از جمله توانایی کار با APIها ,
          React-Hook-Form , Axios , jest , service worker و... با روحیه کار تیمی
          و همچنین توانایی بالا در حل مسأله میتوانم در پیش برد هدفهای تیم موثر
          باشم. در مسیر حرفه‌ای خود به دنبال رشد مداوم در حوزه فرانت اند و سپس
          بک اند هستم .
        </p>
